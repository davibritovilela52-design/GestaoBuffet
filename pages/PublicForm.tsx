...
export default function PublicForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-[#111418] relative">
        {/* Toast Notification */}
        {toast && (
            <div className={`fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-xl border flex items-center gap-3 animate-bounce-in ${
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 md:px-10 sticky top-0 z-40 shadow-sm flex justify-between items-center">
            ...
            <a href="#/login" className="text-sm font-bold text-gray-500 hover:text-primary transition-colors">Área da Equipe</a>
        </header>
